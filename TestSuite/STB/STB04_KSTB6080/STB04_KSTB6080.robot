*** Settings ***
# Resource    /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Robot/STB/STB04_KSTB6080/etisalat.robot
Resource    /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Robot/STB/STB04_KSTB6080/Demo_Keywords.robot
Resource	/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/TestSuite/STB/STB04_KSTB6080/Recorder.resource
Library     /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/STB04_KSTB6080/TeardownStatusTC.py
Library     /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/STB04_KSTB6080/generic.py
Library     /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/STB04_KSTB6080/VideoQuality/Video_metrics_wrapper.py
# Library     /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/Etisalat_Android_STB1/audio_quality.py
Library           BuiltIn
Library           Collections
...
TC_954_NETWORK_TEST_MENU
	...
	Run Keyword If  '${Result}' == 'True'  Log To Console  TC_954_test1 Is Displayed
	...
	Run Keyword If  '${Result}' == 'True'  Log To Console  TC_954_Test2 Is Displayed
	...  ELSE  Fail  TC_954_Test2 Is Not Displayed
	CLICK BACK
	Sleep    20s 
	CLICK HOME
...
TC_966_SPLASH_SCREEN_AT_BOOT
	...
	...  ELSE  Fail  TC_966_Home Is Not Displayed on screen
	Sleep    2s
...
TC_507_STOP_VOD_MID_PLAYBACK_CONFIRM_EXIT_VOD_LIBRARY
	...
	CLICK BACK
		${Result}  Verify Crop Image  ${port}  ACTION
...
TC_516_VERIFY_VOD_PROGRESS_BAR_TIMESTAMP
    [Tags]    VOD
	[Documentation]    Browse VOD and verify rprogress bar
    CLICK HOME
	CLICK UP
    CLICK RIGHT
    CLICK RIGHT
...
TC_528_VERIFY_RELATED_CONTENT_SECTION
    ...
    CLICK RIGHT
	CLICK OK
	Log To Console    Navigated to Box Office
	CLICK RIGHT
    CLICK RIGHT
	CLICK RIGHT
    CLICK OK
...
TC_529_VOD_LIBRARY_KIDS_SECTION_CONTENT
	...
	${Result}  Verify Crop Image With Shorter Duration      ${port}  TC529_Kids_G
...
TC_539_VERIFY_DISPLAY_LAST_VIEWED_VOD
	...
	CLICK RIGHT
	Sleep    1s
	${Result}  Verify Crop Image With Shorter Duration       ${port}  TC_539_CONTINUE_WATCH
...
TC_548_DISPLAY_RENTED_HISTORY
    ...
    # ---------- OCR COMPARISON ----------
    ${ocr_text}=    Normalize Text    ${ocr_text}
    ${txn_ocr}=     Normalize Text    ${txn_ocr}
	Log To Console    RENT OCR: ${ocr_text}
...
TC_562_VOD_LIBRARY_KIDS_SECTION_CONTENT_IN_SUB_PROFILE
	...
	Navigate To Profile
	${Result}  Verify Crop Image  ${port}  abcd_profile
	Run Keyword If  '${Result}' == 'True'  Log To Console  abcd_profile Is Displayed
	...  ELSE  Fail  abcd_profile Is Not Displayed
	CLICK RIGHT
	CLICK OK
	CLICK TWO
	CLICK TWO
...
TC_311_VERIFY_PAUSE_POWER_CYCLE_RESUME
	...
	${channel_number_after_so}=    Hide Channel
    Should Be Equal    ${channel_number_after_so}    11
...
TC_208_VERIFY_AUDIO_LANGUAGE_CHANGE
	...
	${Result}  Verify Crop Image  ${port}  English_Audio
	...
	${Result}  Verify Crop Image  ${port}  TC_219_BENGALI_AUDIO
...
TC_221_VERIFY_FAVORITE_LIVE_TV
	...
	CLICK OK
	${Result}  Verify Crop Image   ${port}  TC_021_Audio_english
...
TC_726_VERIFY_CATCHUP_STOP_SWITCH_LIVETV_RESUME
	...
	CLICK DOWN
	CLICK OK
	Log To Console  Navagating to Catchup
	CLICK RIGHT
	CLICK OK
	...
	...  ELSE  Fail  Video playback is starting from begining
	CLICK OK
...
TC_719_VERIFT_CATCHUP_PLAYBACK_RESUMES_FROM_LAST_WATCHED_POSITION_AFTER_STB_REBOOT
    ...
    ...    Log To Console    video playback is started from begining
    ...    AND    Exit For Loop
...
TC_601_RESTART_LIVE_PROGRAM_USING_START_OVER
	...
	...  ELSE  Log To Console  Video is Playing
	CLICK UP
	${live_status}=    Get Live Progress Bar Status
	CLICK HOME
    Sleep    2s
...
TC_845_VERIFY_NOW_PLAYING_INFO_BAR_FOR_RADIO
	...
	Sleep    18s 
	CLICK UP
	${Result}    Verify Crop Image With Shorter Duration        ${port}   Channel_Logo_1201
	...
	CLICK RIGHT
	Sleep    1s
	${Result}    Verify Crop Image With Shorter Duration        ${port}    Future_Program_Description
	...
	${Result}    Verify Crop Image With Shorter Duration        ${port}    Future_Program_Details_Later
...
TC_803_CHECK_NEXT_DAY_PROGRAM_LISTINGS_UNDER_EPG
	...
	Sleep    2s 
	CLICK DOWN
	${Result}  Verify Crop Image  ${port}  Tommorrow_6080
	Run Keyword If  '${Result}' == 'True'  Log To Console  Tommorrow_6080 Is Displayed
	...  ELSE  Fail   Tommorrow_6080 Is Not Displayed
	CLICK LEFT
...
TC_808_VERIFY_PROGRAM_DESCRIPTIONS_UNDER_EPG
	...
	Run Keyword If  '${Result}' == 'True'  Log To Console     Channel Number Is Displayed
	...  ELSE  Log To Console  Channel Number Is Not Displayed
	# ${Result}  Verify Crop Image With Shorter Duration   ${port}   TC_808_Program_Description
	# Run Keyword If  '${Result}' == 'True'  Log To Console     Program_Description Is Displayed
	# ...  ELSE  Fail  Program_Description Is Not Displayed
	...
	Run Keyword If  '${Result}' == 'True'  Log To Console     Channel_Logo Is Displayed
	...  ELSE  Log To Console  Channel_Logo Is Not Displayed
	
	Sleep    18s  
	CLICK UP
	${Result}    Verify Crop Image With Shorter Duration   ${port}    TC_808_Now_Playing
	Run Keyword If  '${Result}' == 'True'  Log To Console     Now_Playing Is Displayed
	...  ELSE  Log To Console  Now_Playing Is Not Displayed
	...
	...  ELSE  Log To Console  Extra_Details_Android Is Not Displayed
	...
	Run Keyword If  '${Result}' == 'True'  Log To Console     Future_Program_Description Is Displayed
	...  ELSE  Log To Console  Future_Program_Description Is Not Displayed
	${Result}    Verify Crop Image With Shorter Duration   ${port}    TC_808_Future_Program_Details_Later
	Run Keyword If  '${Result}' == 'True'  Log To Console     Later Is Displayed
	...  ELSE  Log To Console  Later Is Not Displayed
...
TC_811_VERIFY_AGE_APPROPRIATE_PROGRAMS_UNDER_CHILD_PROFILE
	...
	Sleep    1s 
	CLICK RIGHT
	${Result}  Verify Crop Image  ${port}    TC_811_KIDS_PROFILE
	...
	CLICK BACK
	CLICK RIGHT
    ${Result}  Verify Crop Image  ${port}    TC_811_KIDS
	...
	CLICK BACK
	CLICK RIGHT
	${Result}  Verify Crop Image  ${port}    TC_811_KIDS_2
...
TC_825_CONFIRM_LAST_VIEWED_POSITION_RETAINS_AFTER_POWER_CYCLE
	...
	...  ELSE  Log To Console  TC_825_Last_retained_Channel Is Not Displayed on screen
	Sleep    1s 
	Reboot STB Device
	CLICK HOME
    Sleep    3s 
...
TC_832_CHECK_ADD_TO_FAVORITE_OPTION_IN_EPG
	...
	CLICK OK
	CLICK LEFT
	${Result}  Verify Crop Image  ${port}  MY_TV_FAVORITES
...
TC_836_SCHEDULE_RECORDING_FOR_FUTURE_PROGRAM_UNDER_EPG_FOR_LOCAL_STORAGE
	...
	Run Keyword If  '${Result}' == 'True'  Log To Console  Recording_Set_Icon Is Displayed
	...  ELSE  Log To Console  Recording_Set_Icon Is Not Displayed
	Sleep    2s 
	${Result}  Verify Crop Image With Shorter Duration    ${port}  Added
	Run Keyword If  '${Result}' == 'True'  Log To Console  Success_Popup Is Displayed
	...  ELSE  Log To Console  Success_Popup Is Not Displayed
	CLICK OK
	CLICK BACK
	Sleep    2s 
	Log To Console    Scheduled program
	...
	Run Keyword If  '${Result}' == 'True'  Log To Console  Dubai_Tv_Under_Recorder Is Displayed
	...  ELSE  Log To Console  Dubai_Tv_Under_Recorder Is Not Displayed
	
	${Result}  Verify Crop Image With Shorter Duration    ${port}  Local_Storage_Under_Recorder
	Run Keyword If  '${Result}' == 'True'  Log To Console  Local_Storage_Under_Recorder Is Displayed
	...  ELSE  Log To Console  Local_Storage_Under_Recorder Is Not Displayed
	CLICK DOWN
	CLICK OK
	# CLICK UP
	CLICK LEFT
...
TC_407_RECORD_TWO_CHANNELS_SIMULTANEOUSLY_TO_LOCAL_STORAGE
    ...
    Verify Matching Channels    ${recorded_channel_text}    ${channel_name1}  
...
TC_464_RECORD_LIVE_CHANNEL_IN_MANUAL_RECORDING_MODE_FUTURE_DATE_TO_CLOUD_STORAGE
    [Tags]    RECORDING
	[Teardown]    STOP SCHEDULE RECORING 
    CLICK HOME
    Log To Console    Navigated To Home Page
    CLICK UP
    CLICK RIGHT
...
#     CLICK OK
	...
	CLICK OK
	CLICK DOWN
	${Result}  Verify Crop Image  ${port}  TC_215_CLOUD_STORAGE
...
TC_008_PROFILE_TV_EXPERIENCE_AUDIOLANGUAGE_CHANGE
	...
	# CLICK DOWN
	# CLICK OK
	${Result}  Verify Crop Image  ${port}   Arabic_Audio_Language_Playback1
...
TC_011_PROFILE_TV_EXPERIENCE_CHANNEL_LOCK
	...
	CLICK ONE
	Sleep    3s 
	${Result}  Verify Crop Image  ${port}  Channel_Lock_Pop_Up
...
TC_018_PROFILE_INTERFACE_SETTING_CHANNEL_STYLE
    [Tags]    PROFILE & EDIT 
	[Teardown]    Revert channel style changes
	CLICK HOME
	CLICK UP
	CLICK RIGHT
	CLICK RIGHT
	...
	Sleep    15s 
	CLICK OK
	${Result}  Verify Crop Image  ${port}  TC_018_first_tile5
	Run Keyword If  '${Result}' == 'True'  Log To Console  TC_018_first_tile Is Displayed on screen
	...  ELSE  Fail  TC_018_first_tile Is Not Displayed on screen
	
	Sleep    2s 
	${Result}  Verify Crop Image  ${port}  TC_018_last_tile5
	Run Keyword If  '${Result}' == 'True'  Log To Console  TC_018_last_tile Is Displayed on screen
	...  ELSE  Fail  TC_018_last_tile Is Not Displayed on screen
...
TC_023_EDIT_PROFILE_USER_LANGUAGE_PREFERENCE
    [Tags]    PROFILE & EDIT 
    [Teardown]    Run Keywords    Revert UI language    AND    Teardown exit whos watching page and login to Admin    AND    DELETE PROFILE
	CREATE PROFILE
	CLICK HOME
	CLICK UP
	CLICK RIGHT
...
TC_2008_VERIFY_CHANNEL_UNHIDE_INDIVIDUALLY_WITH_REBOOT
	...
	${status}=   Get channel number 34 from channel list
...
TC_865_ACCESS_CLOUD_GAME_REQUIRING_PREMIUM_SUBSCRIPTION_VERIFY_PAYMENT_PROMPT_APPEARS
	...
	CLICK OK
	Sleep   30s
	${Result}  Verify Crop Image  ${port}    buy-gaming
	...
	CLICK DOWN
	CLICK LEFT
	${Result}  Verify Crop Image  ${port}    order_gaming
...
TC_604_STARTOVER_FF_TO_LIVE_RESUME
	...
	# ${Result}  Verify Crop Image  ${port}  32X_SPEED
	# Run Keyword If  '${Result}' == 'True'  Log To Console  32X_SPEED Is Displayed
	# ...  ELSE  Fail  32X_SPEED Is Not Displayed

*** Settings ***
# Resource    /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Robot/STB/STB07_DWI259S/etisalat.robot
Resource    /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Robot/STB/STB07_DWI259S/Demo_Keywords.robot
Resource	/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/TestSuite/STB/STB07_DWI259S/Recorder.resource
Library   /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/STB07_DWI259S/TeardownStatusTC.py
...
# Library   /home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/STB07_DWI259S/audio_quality.py
Library           BuiltIn
Library           Collections
...
TC_911_DIAGNOSIS_SELF_CARE
    ...
    ...  ELSE  Log To Console  TV Is Not Displayed
    ...
    ...  ELSE  Log To Console  Internet Is Not Displayed
    ...
    ...  ELSE  Log To Console  Landline Is Not Displayed
	Sleep    2s
	CLICK OK
	Sleep    8s
    ...
    ...  ELSE  Log To Console  Troubleshoot_TV Is Not Displayed
	CLICK RED
	Sleep    20s
	CLICK HOME
	Sleep    2s
    ...
    ...  ELSE  Log To Console  Troubleshoot_Internet Is Not Displayed
	CLICK RED
	Sleep    20s
	CLICK HOME
	Sleep    2s
    ...
    ...  ELSE  Log To Console  Troubleshoot_Phone Is Not Displayed
	# CLICK RED
	# Sleep    20s
	# CLICK HOME
	# Sleep    2s
...
TC_607_STARTOVER_SUBTITLES_VERIFY
    ...
    ${language_ar}=    Capture Multiple Screens And Validate Language    ar
	Run Keyword If  '${Result}' == 'True'  Log To Console  Expected Language Displayed
	...  ELSE  Log To Console  Expected Language Not Displayed
	CLICK UP
	CLICK RIGHT
	CLICK RIGHT
	CLICK RIGHT
...
TC_807_SEARCH_PROGRAM_IN_EPG_AND_VIEW_DETAILS
	...
	CLICK OK
	CLICK RIGHT
    ${Result}  Verify Crop Image With Shorter Duration    ${port}  TC_807_Channel_Name 
...
TC_837_VERIFY_PROGRAM_DESCRIPTIONS_UNDER_EPG_FOR_SUBPROFILE
	...
	...  ELSE  Log To Console  Extra_Details Is Not Displayed
...
TC_020_EDIT_PROFILE_ENABLE_PARENTAL_CONTROL_RESTRICT_CHANNEL
    ...
    Create new profile with 3333 pin
	Navigate To Profile
	Log To Console  Verifying new_user on Screen
	${Result}  Verify Crop Image With Shorter Duration    ${port}  abcd_profile
	Run Keyword If  '${Result}' == 'True'  Log To Console  TC_020_New_User Is Displayed on screen
	...  ELSE  Fail  TC_020_New_User Is Not Displayed on screen
	CLICK RIGHT
...
TC_009_PROFILE_TV_EXPERIENCE_SUBTITLE_LANGUAGE_CHANGE
	...
	...  ELSE  Log To Console   TC_009_ARABIC Is Not Displayed
	...
	...  ELSE  Log To Console   None_Validation Is Not Displayed
	...
	...  ELSE  Log To Console   CONFIRM_AUDIO_ENGLISH Is Not Displayed
...
TC_2017_VERIF_ALWAYS_LOGIN_WITH_THIS_PROFILE_FUNCTIONALITY_IN_PROFILE_SETTINGS_PAGE_WITH_REBOOT
	...
	CLICK RIGHT
	CLICK OK
	${Result}  Verify Crop Image With Shorter Duration    ${port}  Logged_In_Default_profile
	Run Keyword If  '${Result}' == 'True'  Log To Console  Logged_In_Subprofile Is Displayed on screen
	...  ELSE  Fail  Logged_In_Subprofile Is Not Displayed on screen
	CLICK OK
	Sleep    2s 

...
class TestReportGenerator:
    def __init__(self, trigger_id, agent_id, report_title="Test Report"):
        self.xml_file = r"/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/STB07_DWI259S/Report"
        self.VisuleReportpath = r"/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Visual_Reports"
        self.company_logo = r"/home/ltts2/Documents/EvQUAL_Logo.png"
    ...
    def access_report_file(self, output_file):
        PORT = 8070  # Change port number if needed
...
#/home/ltts/Documents/evqual_automation/agentLinuxSTB2/workspace/Visual_Reports
        ...
        # http_report_link = f"http://192.168.1.46:{PORT}/workspace/Visual_Reports/{file_report_name}"
        http_report_link = f"http://192.168.1.46:{PORT}/{file_report_name}"
    ...
    def run(self):
        ...
        if not output_file:
            print("❌ No report generated. Build will continue without API update.")
            return
        # if output_file:

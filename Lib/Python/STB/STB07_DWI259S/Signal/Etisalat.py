import sys
sys.path.append("/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/STB07_DWI259S")
...
def etisalat_tv_cmds(button_name):
    try:
        ...
        cmd = f'ip="192.168.1.143" dataset="TCH_Android" signal="{button_name}" output="2:100"'

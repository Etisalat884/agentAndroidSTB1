...
#     reader = easyocr.Reader(['en', 'ar','da'], gpu=False)
...
#             return True
#         elif expected_language == "da" and any('\u00E6' <= c <= '\u00E6' or '\u00F8' <= c <= '\u00F8' or '\u00E5' <= c <= '\u00E5' or 
#                                       '\u00C6' <= c <= '\u00C6' or '\u00D8' <= c <= '\u00D8' or '\u00C5' <= c <= '\u00C5' for c in text):
...
#     Arabic and Danish require different language readers.
#     """
#     if not os.path.exists(image_path):
#         raise FileNotFoundError(f"Image not found: {image_path}")

#     # Initialize EasyOCR reader based on expected_language
...
#     """
#     Extracts text from image using EasyOCR.
#     Arabic, Danish, Finnish, Norwegian, Swedish require different language readers.
#     """
#     if not os.path.exists(image_path):
#         raise FileNotFoundError(f"Image not found: {image_path}")
...
#     elif expected_language == "da":
#         reader = easyocr.Reader(['en', 'da'], gpu=False)
#     elif expected_language == "fi":
#         reader = easyocr.Reader(['en', 'fi'], gpu=False)
#     elif expected_language == "no":
#         reader = easyocr.Reader(['en', 'no'], gpu=False)
#     elif expected_language == "sv":
#         reader = easyocr.Reader(['en', 'sv'], gpu=False)
#     else:
#         reader = easyocr.Reader(['en'], gpu=False)  # default English
...
#             logger.console(f"Frame contains Danish subtitle: '{text}'")
#             return True
#         elif expected_language == "fi" and any(
#             '\u00E4' in text or '\u00F6' in text or '\u00C4' in text or '\u00D6' in text
#             for c in text):
#             logger.console(f"Frame contains Finnish subtitle: '{text}'")
#             return True
#         elif expected_language == "no" and any(
#             '\u00E6' in text or '\u00F8' in text or '\u00E5' in text or '\u00C6' in text or '\u00D8' in text or '\u00C5' in text
#             for c in text):
#             logger.console(f"Frame contains Norwegian subtitle: '{text}'")
#             return True
#         elif expected_language == "sv" and any(
#             '\u00E4' in text or '\u00F6' in text or '\u00E5' in text or '\u00C4' in text or '\u00D6' in text or '\u00C5' in text
#             for c in text):
#             logger.console(f"Frame contains Swedish subtitle: '{text}'")
#             return True

...
# import RedRatHub
import sys
sys.path.append("/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Lib/Python/STB/STB04_KSTB6080")
...
def etisalat_tv_cmds(button_name):
    try:
        ...
        cmd = f'ip="192.168.1.143" dataset="KAON_Linux" signal="{button_name}" output="9:100"'

...
# /home/ltts/Documents/evqual_automation/agentLinuxSTB2/workspace/Etisalat_Linux_STB2/Report/log-20250605-154136.xml
    def syncReports(self):
        file_Path = '/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/STB04_KSTB6080'
    ...
    #     http_link = f"http://192.168.1.46:{PORT}/workspace/STB04_KSTB6080/Report/{file_name}"
    ...
    def access_html_file(self, html_file_path):
        ...
        # Use your known IP
        http_link = f"http://192.168.1.46:8090/{file_name}"

        print(f"Access your HTML file at: {http_link}")
        return http_link
    
    def access_logs_file(self, file_log_url):
        PORT = 8091  # Change port number if needed
        # Handler = http.server.SimpleHTTPRequestHandler
        # Function to access a specific HTML file
        # Change directory to where the HTML file is located
        ...
        # http_log_link = f"http://192.168.1.46:{PORT}/workspace/Record/STB04_KSTB6080/OutputRecordings/{file_logs_name}"
    ...
    def SendRP(self):
        ...
        directory_path = r'/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/STB04_KSTB6080/Report'
        ...
        directory_log_path = r"/home/ltts2/Documents/evqual_automation/agentAndroidSTB1/workspace/Record/STB04_KSTB6080/OutputRecordings"

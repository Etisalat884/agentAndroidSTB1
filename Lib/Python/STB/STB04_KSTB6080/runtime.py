...
BASE_PATH = os.path.abspath(os.path.join(SCRIPT_DIR, "../../../../Images_Linux"))  # Goes up to etisalatautomation/
...
# capture_crop("TC_214_fav")
# print(tempMatch(0, "comp_img", "TC_214_fav"))
